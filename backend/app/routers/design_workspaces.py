...
_WORKSPACES = (
    ...
    WorkspaceOut(key="procurement", title="采购工作区", available=False),
    WorkspaceOut(key="zoey", title="Zoey · Permit / 设计", available=False),
    WorkspaceOut(key="sabrina", title="Sabrina · 财务", available=False),
